		...
		<div class="carousel-inner">
            <c:forEach items="${photosList}" var="sk">
                <div class="<c:if test="${sk.id=='1'}">item active</c:if><c:if test="${sk.id!='1'}">item</c:if>">
                    <img alt="First slide" src="images/${sk.photo}">
                </div>
            </c:forEach>
	...
	<div class="main container">
            ...
            <div class="main-a row">
                ...
                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3 text-center">
                    <p>
                        <img src="images/453254312.png">${statistics.studentNumber}<br>
                        <span class="up-3">累计在线学习人数</span>
                    </p>
                    <p>
                        <img src="images/453254312.png">${statistics.workNumber}<br>
